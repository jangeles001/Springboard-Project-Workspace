...
const SelectBox = ({ id, source="/rocket-b.svg", name, population, details, action, actionName, isRowLayout, onImageClick="" }) => {
  ...
  return (
    <div className='select__box'>
      <span className='image-info'>
        <img src={imageSource} onClick={() => onImageClick(id)}></img>
